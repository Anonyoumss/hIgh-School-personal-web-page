...
export default async function handler(
  ...
  try {
    ...
    // Email 1: Send to admin (Yassin) about the contact message
    ...
    // Email 2: Send auto-reply to the user who submitted the form
            ...
            <div style="padding: 40px; text-align: center;">
              ...
              <div style="background: #f8f9fa; padding: 20px; border-radius: 8px; margin: 20px 0; text-align: left;">
                <p style="color: #333; margin: 0 0 15px 0; line-height: 1.6;">
                  Hi there! Thanks so much for reaching out. I'm a 16-year-old high school student passionate about building innovative projects and exploring new technologies. I love turning ideas into code and creating things that matter.
                </p>
